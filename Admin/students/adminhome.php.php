                ...
                if (isset($_SESSION['message'])): ?>
                  <div class="alert alert-success">
                    <?php 
                      ...
                      // session_destroy(); is used to destroy all session data
                    ?>
                  </div>
                  <?php endif;
                ?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="student-update.php?stid=<?php echo $row->employeeID;?>"><i class="fas fa-edit"></i></a>
                      &nbsp;
                      <a href="studen-delete.php?stid=<?php echo $row->employeeID;?>" onclick="return confirm('are you sure you wanna delete this data!@')"><i class="fas fa-trash-alt"></i></a>
                    </td>
                  </tr>
                  <?php endwhile ?>
                  </tbody>
